...
const ScProductLineItem = class {
  ...
  render() {
    return (index.h("div", { class: "base", part: "base" }, index.h("div", { part: "product-line-item", class: {
      ...
      }, tabindex: "0", "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %s %s', 'surecart'), this.name, this.priceName) })) : (index.h("div", null)), this.renderPriceAndInterval())), (this.fees || []).map(fee => {
